...
import freeRegistrationRoutes from './routes/freeRegistrationRoutes.js';
...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Requested-With', 'x-checkin-token'],
  credentials: true,
...
app.use(`/api/${process.env.API_VERSION}/payments/free`, freeRegistrationRoutes);
